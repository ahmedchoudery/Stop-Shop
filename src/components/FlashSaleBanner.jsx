...
const FlashSaleBanner = () => {
  ...
  return (
    <div
      className="flash-banner w-full pointer-events-auto bg-cardinal text-white"
      style={{ height: '36px' }}
      role="banner"
      ...
      <div className="h-full max-w-[1440px] mx-auto px-4 flex items-center justify-between">
        ...
        <div className="flex-grow flex items-center justify-center space-x-4">
          <div className="flex items-center space-x-1.5">
            <Zap size={11} className="text-[#C8102E] fill-[#C8102E] opacity-90 flex-shrink-0" />
          ...
          <div className="hidden sm:flex items-center space-x-1.5">
            ...
            <span
              className="flash-countdown text-[9px] font-mono font-black tabular-nums text-white bg-[#C8102E] px-2 py-0.5 rounded-sm"
              aria-live="polite"
