...
const OrderTable = ({ externalOrders, loading: externalLoading, onStatusUpdated, onViewDetail, isCompact }) => {
  ...
  const handleStatusChange = async (orderId, newStatus) => {
    if (newStatus === 'Shipped') {
      alert('To mark an order as Shipped, please click the row or "View Details" to open the sidebar and enter Courier and Tracking information.');
      return;
    }
    try {
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-150">
                ...
                {!isCompact && <th className="p-4 text-[9px] font-black uppercase tracking-[0.3em] text-gray-400">Items</th>}
                ...
                {!isCompact && <th className="p-4 text-[9px] font-black uppercase tracking-[0.3em] text-gray-400">Date</th>}
                {!isCompact && <th className="p-4 text-[9px] font-black uppercase tracking-[0.3em] text-gray-400 text-center">Actions</th>}
              </tr>
            </thead>
