      ...
      <div className="bg-white w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-sm shadow-2xl relative print:shadow-none print:max-h-none print:overflow-visible print:w-full">
        ...
        <div className="sticky top-0 bg-white border-b border-gray-100 p-6 flex justify-between items-center z-10 print:hidden">
          <div className="flex items-center space-x-3">
            <Package className="text-cardinal" size={24} />
        ...
        <div className="p-8 sm:p-12 print:p-0">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start mb-12 border-b-4 border-cardinal pb-8">
            <div>
              <h1 className="text-4xl font-black italic uppercase tracking-tighter text-cardinal">Stop & Shop</h1>
            ...
            <div className="mt-8 sm:mt-0 text-right">
              ...
              <div className="relative z-10">
                ...
                <p className="text-2xl font-black text-cardinal font-mono mt-1">{order.orderID}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 print:hidden">
              ...
              <button
                ...
                className={`px-4 py-2 text-[10px] font-black uppercase tracking-widest rounded-sm transition-all shadow-md ${
                  order.status === 'Shipped' 
                    ? 'bg-gray-200 text-gray-600 hover:bg-cardinal hover:text-white' 
                    : 'bg-cardinal text-white hover:brightness-110'
                }`}
              >
            ...
            {/* Print Card */}
            <div className="bg-cardinal/5 p-6 rounded-sm border border-cardinal/10 flex items-center justify-between">
              <div className="flex items-center space-x-4 text-cardinal">
                <Printer size={24} />
                <p className="text-sm font-black uppercase tracking-widest">Printer-Friendly Version</p>
              </div>
              <button
                onClick={handlePrint}
                className="bg-cardinal text-white px-6 py-2 text-[10px] font-black uppercase tracking-widest rounded-sm hover:brightness-110 transition-all shadow-lg"
              >
                Print Invoice
              </button>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-2 border-b border-gray-100 pb-2 pt-4">
                <MapPin size={16} className="text-cardinal" />
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-2 border-b border-gray-100 pb-2">
                <CreditCard size={16} className="text-cardinal" />
                <h3 className="text-[11px] font-black uppercase tracking-[0.2em] text-gray-400">Transaction Details</h3>
              </div>
              <div className="bg-gray-50 p-4 border-l-4 border-cardinal">
              ...
              <div className="bg-cardinal text-white p-6 rounded-sm shadow-xl relative overflow-hidden group">
                ...
                <tbody className="divide-y divide-gray-100">
                  {order.items.map((item) => (
                    <tr key={item.id} className="text-sm">
                      <td className="p-4 font-mono text-[10px] font-bold text-cardinal">{item.id}</td>
                      ...
                      <td className="p-4 text-right font-black text-cardinal">PKR {(item.price * (item.quantity || 1)).toLocaleString()}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div className="mt-20 pt-12 border-t border-gray-100 text-center space-y-4">
            <div className="flex items-center justify-center space-x-2">
              <div className="h-1 w-12 bg-cardinal"></div>
              <p className="text-[10px] font-black uppercase tracking-[0.5em] text-cardinal">Authentic Supply Chain</p>
              <div className="h-1 w-12 bg-cardinal"></div>
            </div>
