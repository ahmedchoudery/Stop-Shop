 ...
 * Coupon / discount code input for the checkout form.
 * Calls /api/public/coupons/validate and returns discount amount to parent.
 *
...
const CouponInput = ({ cartTotal, onApply, onRemove, appliedCoupon }) => {
  ...
  const handleApply = async () => {
    ...
    try {
      ...
      onApply(data); // { code, type, value, discount, finalTotal, message }
      setCode('');
    } catch {
    ...
    return (
      <div className="flex items-center justify-between p-4 bg-green-50 border border-green-200 rounded-sm animate-fade-up">
        ...
        <button
          ...
          className="p-1.5 text-green-400 hover:text-green-700 hover:bg-green-100 rounded-lg transition-all"
          title="Remove coupon"
        >
          <X size={14} />
        </button>
      ...
      <div className="flex space-x-2">
        ...
        <div className="relative flex-grow">
          ...
          <input
            ...
            className="
              ...
              border-2 border-gray-200 focus:border-[#ba1f3d]
        ...
        <button
          ...
          className="
            ...
            hover:bg-[#ba1f3d] transition-all duration-300
