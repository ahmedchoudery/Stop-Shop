...
export default function BrandStrip() {
  ...
  return (
    <section
      className="bg-white text-gray-900 border-y border-gray-200 overflow-hidden select-none"
      onMouseEnter={() => {
    ...
    >
      <div className="relative w-full flex items-center py-4">
        ...
        <div className="absolute left-0 top-0 bottom-0 w-16 z-10 pointer-events-none bg-gradient-to-r from-white via-white/60 to-transparent" />
        <div className="absolute right-0 top-0 bottom-0 w-16 z-10 pointer-events-none bg-gradient-to-l from-white via-white/60 to-transparent" />
        ...
        >
          {allUSPs.map(({ icon: Icon, label, sub }, i) => (
            ...
            >
              <div className="w-8 h-8 border border-gray-200 flex items-center justify-center bg-gray-50 flex-shrink-0">
