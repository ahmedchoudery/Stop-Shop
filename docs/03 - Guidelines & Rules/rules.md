...
- **Strict No-Auto-Generated Descriptions or Care Instructions**: The system MUST NEVER automatically generate, output, or fall back to fake or hardcoded description or care instruction strings. If the admin leaves description or care instructions empty, no text or tab is generated for that field. The product detail page only displays description or care instruction tabs when the admin explicitly provided custom content.
